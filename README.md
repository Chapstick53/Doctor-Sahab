...
🎯 Visuals to Showcase on GitHub
    ...
    Database Schema Diagram – ER diagram for table relationships

    API Documentation Screenshots – Postman / Swagger examples

    Architecture Diagrams – System flow + API structure

    Code Quality Metrics – Folder structure, clean code snippets

    Performance Metrics – API response times, query optimizations, load testing

    Security Implementation – JWT flow diagram, password hashing, validation examples
